...
public class DBScanOptions {
	...
	@Parameter(names = { "-dt",
			"--clusteringDistanceThresholds" }, description = "Comma separated list of distance thresholds, per dimension")
	private String clusteringDistanceThresholds;

	@ClusteringParameter(ClusteringParameters.Clustering.GEOMETRIC_DISTANCE_UNIT)
	@Parameter(names = { "-du",
			"--clusteringGeometricDistanceUnit" }, description = "Geometric distance unit (m=meters,km=kilometers, see symbols for javax.units.BaseUnit)")
	...
	@Parameter(names = { "-cms", "--clusteringMinimumSize" }, description = "Minimum Cluster Size")
	...
	@Parameter(names = { "-hhb", "--hullHullBuilder" }, description = "Hull Builder")
	...
	@Parameter(names = { "-ons",
			"--outputDataNamespaceUri" }, description = "Output namespace for objects that will be written to GeoWave")
	private String outputDataNamespaceUri;

	@OutputParameter(OutputParameters.Output.DATA_TYPE_ID)
	@Parameter(names = { "-odt",
			"--outputDataTypeId" }, description = "Output Data ID assigned to objects that will be written to GeoWave")
	private String outputDataTypeId;

	@OutputParameter(OutputParameters.Output.INDEX_ID)
	@Parameter(names = { "-oid",
			"--outputIndexId" }, description = "Output Index ID for objects that will be written to GeoWave")
	private String outputIndexId;

	@PartitionParameter(PartitionParameters.Partition.MAX_MEMBER_SELECTION)
	@Parameter(names = { "-pms",
			"--partitionMaxMemberSelection" }, description = "Maximum number of members selected from a partition")
	...
	@Parameter(names = { "-pdr",
			"--partitionPartitionDecreaseRate" }, description = "Rate of decrease for precision(within (0,1])")
	private String partitionPartitionDecreaseRate;

	@PartitionParameter(PartitionParameters.Partition.PARTITION_DISTANCE)
	@Parameter(names = { "-pd", "--partitionPartitionDistance" }, description = "Partition Distance")
	...
	@Parameter(names = { "-psp",
			"--partitionSecondaryPartitionerClass" }, description = "Perform secondary partitioning with the provided class")
	...
	public void setClusteringDistanceThresholds(String clusteringDistanceThresholds) {
	...
	public void setClusteringGeometricDistanceUnit(String clusteringGeometricDistanceUnit) {
	...
	public void setHullHullBuilder(String hullHullBuilder) {
	...
	public void setPartitionPartitionDistance(String partitionPartitionDistance) {
