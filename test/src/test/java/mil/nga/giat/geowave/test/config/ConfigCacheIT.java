...
public class ConfigCacheIT {
	...
	public void addStore() {
		...
		Properties props = ConfigOptions.loadProperties(configFile, null);
		
		Assert.assertEquals("zoo", props.getProperty("store.abc.opts." + AccumuloRequiredOptions.ZOOKEEPER_CONFIG_KEY));
		Assert.assertEquals("user", props.getProperty("store.abc.opts." + AccumuloRequiredOptions.USER_CONFIG_KEY));
		Assert.assertEquals("inst", props.getProperty("store.abc.opts." + AccumuloRequiredOptions.INSTANCE_CONFIG_KEY));
		Assert.assertEquals("pass", props.getProperty("store.abc.opts." + AccumuloRequiredOptions.PASSWORD_CONFIG_KEY));
	...
	public void addStoreFromDefault() {
		...
		Assert.assertEquals("zoo", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.ZOOKEEPER_CONFIG_KEY));
		Assert.assertEquals("user2", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.USER_CONFIG_KEY));
		Assert.assertEquals("inst", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.INSTANCE_CONFIG_KEY));
		Assert.assertEquals("pass", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.PASSWORD_CONFIG_KEY));
	}
	...
	public void copyStore() {
		...
		Assert.assertEquals("zoo", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.ZOOKEEPER_CONFIG_KEY));
		Assert.assertEquals("user", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.USER_CONFIG_KEY));
		Assert.assertEquals("inst", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.INSTANCE_CONFIG_KEY));
		Assert.assertEquals("pass", props.getProperty("store.abc2.opts." + AccumuloRequiredOptions.PASSWORD_CONFIG_KEY));		
	}
