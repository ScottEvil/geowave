...
public class JCommanderTranslationMap
{
	...
	/**
	 * Return all the translations as an unmodifiable map. They are indexed by
	 * 'field name', where field name is the field in the facade object.
	 * 
	 * @return
	 */
	...
	/**
	 * Get the translation for the given field name
	 * 
	 * @param name
	 * @return
	 */
	...
	protected void addEntry(
		...
		// This is so we know whether the main parameter would "absorb" any
		// additional operations
		// when we're attempting to determine what the operation is while
		// parsing.
		if (param.getParameter() != null && param.getParameter().names().length == 0) {
	...
	/**
	 * This special function will return true if the "MainParameter" concept in
	 * JCommander is present in at least one of the fields present.
	 * 
	 * @return
	 */
	public boolean hasMainParameter() {
		return hasMainParameter;
	}
